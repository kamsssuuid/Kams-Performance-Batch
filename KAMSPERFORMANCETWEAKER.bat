...
:: Batch File Log
echo Kam's Performance Batch Log >APB_Log.txt
...
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'Kams Performance Batch' -RestorePointType 'MODIFY_SETTINGS'" >> APB_Log.txt
...
curl -g -k -L -# -o "C:\NvidiaProfileInspector\kams_nv_profile.nip" "https://github.com/kamsssuuid/Kams-Performance-Batch/raw/refs/heads/main/bin/Kams_nv_profile.nip" >> APB_Log.txt
start "" /wait "C:\NvidiaProfileInspector\nvidiaProfileInspector.exe" "C:\NvidiaProfileInspector\kams_nv_profile.nip" >> APB_Log.txt
timeout /t 3 /nobreak > NUL
...
:PowerPlan
cls
echo Applying Kams Power Plan
:: Import Kams Power Plan
curl -g -k -L -# -o "C:\Kams_Power_Plan.pow" "https://github.com/kamsssuuid/Kams-Performance-Batch/raw/refs/heads/main/bin/Kams_Power_Plan.pow" >> APB_Log.txt
powercfg -import "C:\Kams_Power_Plan.pow" 64368257-6435-6453-1634-836473856382 >> APB_Log.txt
powercfg -setactive 64368257-6435-6453-1634-836473856382 >> APB_Log.txt
timeout /t 3 /nobreak > NUL
...
:: Install DevManView
curl -g -k -L -# -o "C:\Windows\System32\DevManView.exe" "https://github.com/kamsssuuid/Kams-Performance-Batch/raw/refs/heads/main/bin/DevManView.exe" >> APB_Log.txt
timeout /t 3 /nobreak > NUL
...
curl -g -k -L -# -o "C:\KAMOOSUIMPORT.cfg" "https://github.com/kamsssuuid/Kams-Performance-Batch/raw/refs/heads/main/bin/KAMOOSUIMPORT.cfg"
start "" /wait "%temp%\OOSU10.exe" "C:\KAMOOSUIMPORT.cfg" >> APB_Log.txt
cls
